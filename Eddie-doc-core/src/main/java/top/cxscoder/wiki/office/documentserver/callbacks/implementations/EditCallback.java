...
package top.cxscoder.wiki.office.documentserver.callbacks.implementations;


import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Component;
import top.cxscoder.wiki.office.documentserver.callbacks.Callback;
import top.cxscoder.wiki.office.documentserver.callbacks.Status;
import top.cxscoder.wiki.office.documentserver.managers.callback.CallbackManager;
import top.cxscoder.wiki.office.dto.Action;
import top.cxscoder.wiki.office.dto.Track;
...
public class EditCallback implements Callback {
    ...
    public int handle(Track body, String fileName) {  // handle the callback when the document is being edited
        ...
        if (action.getType().equals(top.cxscoder.wiki.office.documentserver.models.enums.Action.edit)) {  // if this value is not equal to the user ID
